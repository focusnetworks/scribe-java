 ...
 * 
 */
public class Twitter2Api extends DefaultApi20 {

	private static final String AUTHORIZE_URL = "https://api.twitter.com/oauth2/token?grant_type=client_credentials";
