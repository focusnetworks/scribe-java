...
public class InstagramApi extends DefaultApi20 {
	...
	/**
	 * Not sure if it's a Scribe bug or an Instagram oddity. We have to send the various parameters in the POST body (Scribe sends them as query string) and we must include the 'grant_type'.
	 */
	@Override
